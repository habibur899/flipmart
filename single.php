                ...
                <div class="blog-page">
                    <div class="col-md-9">
                        ...
                        <div class="blog-post-author-details wow fadeInUp">
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/testimonials/member3.png"
                        ...
                        <div class="blog-review wow fadeInUp">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <img src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/testimonials/member1.png"
                                         alt="Responsive image"
					...
					<a href=""> Reply</a>
                                    ...
                                    <div class="blog-comments-responce outer-top-xs ">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-2">
                                                <img src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/testimonials/member2.png"
                                                     alt="Responsive image"
                                                     class="img-rounded img-responsive">
                                            </div>
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <img src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/testimonials/member4.png"
                                         alt="Responsive image"
                                         class="img-rounded img-responsive">
                                </div>
                                <div class="col-md-10 col-sm-10">
                    ...
                    <div class="col-md-3 sidebar">
                        ...
                        <div class="sidebar-module-container">
                            ...
                            <div class="home-banner outer-top-n outer-bottom-xs">
                                <img src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/banners/LHS-banner.jpg"
                                     alt="Image">
                            </div>
                            <!-- ==============================================CATEGORY============================================== -->
                            ...
                            <div class="sidebar-widget outer-bottom-xs wow fadeInUp">
                                ...
                                <div class="tab-content" style="padding-left:0">
                                    <div class="tab-pane active m-t-20" id="popular">
                                        <div class="blog-post inner-bottom-30 ">
                                            <img class="img-responsive"
                                                 src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/blog-post/blog_big_01.jpg"
                                                 alt="">
                                        ...
                                        <div class="blog-post">
                                            <img class="img-responsive"
                                                 src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/blog-post/blog_big_02.jpg"
                                                 alt="">
                                            <h4><a href="blog-details.html">Simple Blog Post</a></h4>
                                            <span class="review">6 Comments</span>
                                    ...
                                    <div class="tab-pane m-t-20" id="recent">
                                        <div class="blog-post inner-bottom-30">
                                            <img class="img-responsive"
                                                 src="<?php echo esc_url( get_template_directory_uri() ) ?>/assets/images/blog-post/blog_big_03.jpg"
                                                 alt="">
                                            <h4><a href="blog-details.html">Simple Blog Post</a></h4>
                                            <span class="review">6 Comments</span>
